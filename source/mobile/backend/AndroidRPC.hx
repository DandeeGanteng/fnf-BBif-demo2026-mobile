...
class AndroidRPC {
	...
	public static function initialize() {
		if (_init == null)
			_init = JNI.createStaticMethod("java/arkoselabs/utils/KizzyHelper", "initialize", "()V");
	...
	public static function update(title:String, artist:String, ?imagePath:String) {
		...
		if (_update == null) {
			_update = JNI.createStaticMethod("java/arkoselabs/utils/KizzyHelper", "updateStatus", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
		}
	...
	public static function shutdown() {
		if (_shutdown == null)
			_shutdown = JNI.createStaticMethod("java/arkoselabs/utils/KizzyHelper", "shutdown", "()V");
